return {
  -- TODO: Create a picker with vim.ui.inputs "Directories to include" and "File type scope"
  -- TODO: set the path_display so it is easier to view the path of files and preview
    ...
    config = function()
      ...
      require('telescope').setup {
        ...
        defaults = {
          ...
          -- path_display.shorten = { len = 3, exclude { -2, -2 } },
        },
