return {
  { -- Highlight, edit, and navigate code
    ...
    -- dependencies = {
    --   'Urtlp/markview.nvim', -- See the reason at https://github.com/OXY2DEV/markview.nvim?tab=readme-ov-file#-installation
    -- },
    build = ':TSUpdate',
  ...
  --       pattern = { 'c', 'yaml', 'yml', 'gherkin' }, -- gherkin covers .feature if ts grammar is installed
  --       callback = function()
